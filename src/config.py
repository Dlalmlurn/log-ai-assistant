...
settings = Settings(
    ...
    kafka_alert_topic=os.getenv("KAFKA_ANOMALY_TOPIC", os.getenv("KAFKA_ALERT_TOPIC", "anomaly_events")),
    kafka_ai_topic=os.getenv("KAFKA_AI_JUDGEMENT_TOPIC", os.getenv("KAFKA_AI_TOPIC", "ai_judgements")),
